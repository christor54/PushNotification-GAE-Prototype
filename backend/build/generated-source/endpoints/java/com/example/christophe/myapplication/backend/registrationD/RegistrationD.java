 ...
 * on 2015-02-17 at 16:38:39 UTC 
 * Modify at your own risk.
 */

package com.example.christophe.myapplication.backend.registrationD;

/**
 * Service definition for RegistrationD (v1).
 *
 * <p>
 * This is an API
 * </p>
 ...
 *
 * <p>
 * This service uses {@link RegistrationDRequestInitializer} to initialize global parameters via its
 * {@link Builder}.
 * </p>
 *
 * @since 1.3
...
public class RegistrationD extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.19.1 of the registrationD library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://powerful-memory-858.appspot.com/_ah/api/";
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "registrationD/v1/";
   ...
   * @since 1.7
   */
  public RegistrationD(com.google.api.client.http.HttpTransport transport, com.google.api.client.json.JsonFactory jsonFactory,
   ...
   *
   * This request holds the parameters needed by the registrationD server.  After setting any optional
  ...
  public class ListDevices extends RegistrationDRequest<com.example.christophe.myapplication.backend.registrationD.model.CollectionResponseRegistrationRecord> {
     ...
     * Create a request for the method "listDevices".
     *
     * This request holds the parameters needed by the the registrationD server.  After setting any
    ...
    protected ListDevices(java.lang.Integer count) {
      super(RegistrationD.this, "GET", REST_PATH, null, com.example.christophe.myapplication.backend.registrationD.model.CollectionResponseRegistrationRecord.class);
  ...
  public class Register extends RegistrationDRequest<Void> {
    ...
    protected Register(java.lang.String regId) {
      super(RegistrationD.this, "POST", REST_PATH, null, Void.class);
  ...
  public class Unregister extends RegistrationDRequest<Void> {
  ...
  /**
   * Builder for {@link RegistrationD}.
   *
   * <p>
  ...
  public static final class Builder extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient.Builder {
    ...
    /** Builds a new instance of {@link RegistrationD}. */
    @Override
    public RegistrationD build() {
      return new RegistrationD(this);
    }
    ...
    /**
     * Set the {@link RegistrationDRequestInitializer}.
     *
     * @since 1.12
     */
    public Builder setRegistrationDRequestInitializer(
        RegistrationDRequestInitializer registrationdRequestInitializer) {
      return (Builder) super.setGoogleClientRequestInitializer(registrationdRequestInitializer);
    }
