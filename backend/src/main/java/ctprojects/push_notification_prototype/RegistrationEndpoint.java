...
*/
@Api(name = "registrationD", version = "v1", namespace = @ApiNamespace(ownerDomain = "backend.myapplication.christophe.example.com", ownerName = "backend.myapplication.christophe.example.com", packagePath = ""))
